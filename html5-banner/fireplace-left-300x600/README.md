# TM Börsenverlag AG – Fireplace left Sloganbanner (300 × 600 px)

HTML5-Banner mit Tipp-Animation: Die beiden Textblöcke im oberen Bereich werden
Zeichen für Zeichen „getippt“, begleitet von einem weißen, blinkenden
Block-Cursor (wie in alten Texteingabeprogrammen).
...
| `background.png` | Hintergrund ohne Text (Banner 13)                            |
| `fallback.png`   | Statisches Fallback-Motiv mit Text (Banner 11)               |

## Ablauf der Animation

1. Cursor blinkt kurz an der Startposition.
2. Absatz 1 („Ein kostenloser Leitfaden für Ihr Vermögen? Ja, den gibt’s!“)
   wird mit leicht variierendem Tempo getippt.
3. Kurze Pause, dann wird Absatz 2 („Sogar schon mehr als 300.000 Mal
   gedruckt!“) getippt.
...
Gesamtgewicht: ca. 25 KB (ohne Fallback).
